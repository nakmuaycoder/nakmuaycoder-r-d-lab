...
![**TSS Load Curve.** The "Progressiveness" Check. A steady, linear ramp-up with clear deload valleys to allow the nervous system to reboot.](tss.png)

![**Zone Distribution.** The "Polarization" Check. Notice the specific intensity blocks (Orange/Red) appearing in Phase 3 & 4.](fc.png)

![**Vertical Scalability (D+).** The "Hardware Stress Test". We progressively increase elevation gain to condition the tendons for the 8000m of eccentric loading at Chiang Mai.](elevation.png)
:::
