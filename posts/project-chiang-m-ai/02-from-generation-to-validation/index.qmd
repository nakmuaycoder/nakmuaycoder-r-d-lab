...
* **🧪 Test 4: Specificity (Event Parity)**
    ...
    * *Result:* **✅ PASS.** (VO2Max early season -> Specific Endurance late season).
...
::: {layout-ncol=2}
![Initial Version (Bug)](Code_Generated_Image (1).png)

![Patched Version (v1.1)](../01-ai-board-of-directors/viz-zones.jpg)
:::
